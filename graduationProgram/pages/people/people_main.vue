	...
	<div class="root">
		<div class="userInfo" v-if='userInfo.avatar' :style="{
			...
			<div>
				...
				<p class="userName" @click="login" > {{userInfo.name}} </p>
			</div>
		</div>
		<div class = "bottom">			
			<view class="myAction">
				<view class="like" >
					<u-icon name="heart" color="#437796" size="80" @click="goPage('./people_like')"></u-icon>
					<view @click="goPage('./people_like')" >喜欢</view>
				</view>
				<view class="commit">
					<u-icon name="chat" color="#437796" size="80" @click="goPage('./people_comment')"></u-icon>
					<view @click="goPage('./people_comment')" >评论</view>
				</view>
				<view class="collect">
					<u-icon name="star" color="#437796" size="80" @click="goPage('./people_collection')"></u-icon>
					<view @click="goPage('./people_collection')" >收藏</view>
				</view>
			</view>
			<view class="story">
				<view @click="goPage('./people_story')">我的故事</view>
			</view>
			<view class="footPrint">
				<view @click="goPage('./people_footprint')">我的足迹</view>
			</view>						
		</div>
